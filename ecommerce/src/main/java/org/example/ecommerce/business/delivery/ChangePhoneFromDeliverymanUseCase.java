...
import org.example.ecommerce.domain.delivery.command.ChangePhoneFromDeliverymanCommand;
...
@Component
public class ChangePhoneFromDeliverymanUseCase implements UseCaseForCommand<ChangePhoneFromDeliverymanCommand> {

    private final EventsRepository eventsRepository;

    public ChangePhoneFromDeliverymanUseCase(EventsRepository eventsRepository) {
        this.eventsRepository = eventsRepository;
    }
    @Override
    public List<DomainEvent> apply(ChangePhoneFromDeliverymanCommand command) {
        ...
        delivery.changePhoneFromDeliveryman(DeliverymanID.of(command.getDeliverymanID()), new Phone(command.getPhone()));
