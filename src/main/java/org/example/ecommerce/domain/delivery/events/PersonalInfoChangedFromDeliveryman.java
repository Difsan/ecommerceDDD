...
public class PersonalInfoChangedFromDeliveryman extends DomainEvent {
    private final DeliverymanID id;
    private final PersonalInfo personalInfo;


    public PersonalInfoChangedFromDeliveryman(DeliverymanID id, PersonalInfo personalInfo) {
        super("org.example.personalInfoChangedFromDeliveryman");
        this.id = id;
